...
class AppointmentDataModel {
  ...
  AppointmentDataModel({this.appointmentDate,
    this.name,
    this.phone,
    this.comments,
    this.author,
...
class MessagesDataModel {
  ...
  MessagesDataModel({this.patientId,
    this.messagesDate,
    this.from,
    this.status,
    this.message,
...
class VaccineDataModel {
  ...
  VaccineDataModel({this.patientId,
...
class DBDataModel {
  ...
  factory DBDataModel.fromJson(Map<String, dynamic> json) {
    return DBDataModel(
        ...
        error: json['error'],
        message: json['message'],
        data: json['data'].map((value) => UserModel.fromJson(value)).toList());
  }
}
...
class AddressBookModel {
  ...
  const AddressBookModel({this.addressid,
    this.firstName,
    this.middleName,
    this.lastName,
    this.address,
